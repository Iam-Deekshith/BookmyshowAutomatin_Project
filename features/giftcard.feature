Feature: Gift Card Module
 ...
 Background:
    Given User is on home page and select city "Rajamahendravaram"
  ...
  Scenario Outline: Navigate to the Gift Card section and validate Check Gift Card Balance icon
    ...
    |Rajamahendravaram|Gift Card|Check Gift Card Balance|
  ...
  Scenario Outline: Validate error message for invalid gift card voucher
    ...
    |Rajamahendravaram|1223$@XYZ|Please verify input|Gift Card|Check Gift Card Balance|Check Balance|
